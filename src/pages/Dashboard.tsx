  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30 flex flex-col">
      ...
      <div className="sticky top-0 z-20 bg-white/80 backdrop-blur-xl border-b border-gray-200 shadow-sm flex-shrink-0">
        <div className="container mx-auto px-4 sm:px-6 max-w-[1600px] py-3 sm:py-4">
          <div className="flex items-center justify-between gap-4">
            <div className="min-w-0 flex-1">
              <h1 className="text-lg sm:text-2xl font-bold text-slate-900 truncate">
                {t('dashboard.welcome', { name: dashboardStats.userName || t('dashboard.runner') })}
              </h1>
            ...
            >
              ...
              <span className="hidden sm:inline">
                {plans.length === 0 ? t('dashboard.createFirstPlan') : t('dashboard.createNewPlan')}
              </span>
